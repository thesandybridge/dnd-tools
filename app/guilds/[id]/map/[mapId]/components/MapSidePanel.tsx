          ...
          >
            {isEditing ? (
              <>
                ...
                <InlineRename guildId={guildId} mapId={mapId} marker={marker} onDone={() => setEditingUuid(null)} />
              </>
            ) : (
              <>
...
export default function MapSidePanel({ guildId, mapId, open, onClose, selectedMarkerUuid, onSelectMarker }: MapSidePanelProps) {
